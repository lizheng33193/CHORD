...
- dashboard、CI integration、online monitoring、release automation 仍然留在后续 hardening / `M7` 规划，不属于 M6 已交付范围
...
1. 启动 `M7 Planning`：dashboard、CI integration、release automation、report retention 的后续 hardening 设计
2. 继续统一国家支持边界
3. 逐步打通 `warehouse_repository`
4. 提升 `th` 与其他国家 pack 的能力厚度
5. 让 Product Advice / Ops Advice 更充分消费上游信号
6. 在保持默认保守发布边界的前提下，评估 semantic memory 的后续生产化 hardening 路径
