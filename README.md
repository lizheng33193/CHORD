...
`app/release/` 当前已经提供正式的 Pre-M3 release gate 入口：
...
4. 查询词与内容是否有直接重合。当前是 SQLite FTS5，不是 embedding 语义召回
...
- 一个已具备画像、聊天编排、长期记忆、受控取数、风险知识和发布治理能力的本地 Agent Harness
