...
DEFAULT_PERMISSIONS: dict[str, tuple[str, str]] = {
    ...
    "data:bucket:writeback": ("Write back data bucket", "Write approved SQL results into data/*/by_uid"),
    "data:knowledge:read": ("Read data knowledge", "Read data knowledge assets and metadata"),
    "data:knowledge:write": ("Write data knowledge", "Create or update data knowledge assets"),
    "data:knowledge:manage": ("Manage data knowledge", "Import seed knowledge and manage knowledge lifecycle"),
