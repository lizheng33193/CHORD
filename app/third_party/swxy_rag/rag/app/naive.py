...
import re
from app.third_party.swxy_rag.deepdoc.parser.pdf_parser import PlainParser
from app.third_party.swxy_rag.rag.nlp import rag_tokenizer, naive_merge, tokenize_table, tokenize_chunks, find_codec, concat_img, \
    naive_merge_docx, tokenize_chunks_docx
from app.third_party.swxy_rag.deepdoc.parser import PdfParser, ExcelParser, DocxParser, HtmlParser, JsonParser, MarkdownParser, TxtParser
from app.third_party.swxy_rag.rag.utils import num_tokens_from_string
