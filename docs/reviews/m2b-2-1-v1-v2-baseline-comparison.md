...
| mx-behavior-writeback | partial | partial | 0 | 0 | 0 | no_material_change | no |
| mx-credit-profile-query | fail | pass | 5 | -5 | 0 | improved | no |
| mx-first-loan-never-overdue | partial | partial | 0 | 0 | 0 | no_material_change | no |
| mx-glossary-combo-writeback | partial | partial | 1 | -1 | 0 | improved | no |
| mx-high-risk-cohort | partial | pass | 2 | -2 | 0 | improved | no |
| mx-mob1-settled-7d-churn | partial | partial | 0 | 0 | 0 | no_material_change | no |
...
| mx-withdraw-cohort | partial | partial | -1 | 1 | 0 | no_material_change | yes |
